...
HWND hwnd, hDrawbox, hTextbox3, hTextbox1, hTextbox2 , hSearchBar, hButtonAdd, hButtonStart, hButtonStop, hButtonBan, hButtonUnban, hButtonRemove, hTextbox4, hSearchBar1, hSearchBar2, Log_label, performance, stat, ban_label, Trace, TraceBox; // Các control// Khai báo unordered_map để lưu các dòng đã được thêm vào
...
LRESULT CALLBACK WindowProcedure(HWND hwnd, UINT msg, WPARAM wp, LPARAM lp) {
    ...
    case WM_USER + 1: {
        ...
        // cout << "DataReicevedQueue: "; for (auto i : DataReicevedQueue) cout << i << " ";
        ...
        HPEN hPenChart2 = CreatePen(PS_SOLID, 2, RGB(0, 0, 150)); // Green chart line
        ...
        // cout << DataReicevedQueue.size() << endl;
        for (int i = 1; i < DataReicevedQueue.size(); i++) {
            // cout << DataReicevedQueue[i] << " ";
        ...
        // cout << DataSentedQueue.size() << endl;
        for (int i = 1; i < DataSentedQueue.size(); i++) {
            cout << DataSentedQueue[i] << " ";
        ...
        //cout << maxSentBytes << " " << maxReceivedBytes << endl;
        cout << endl;
        ...
        if ((HWND)lp == hButtonBan) {
            ...
            if (wcslen(buffer1) > 0 && wcslen(buffer2) > 0) {
                ...
                if (it == user_ban_list.end()) {
                    ...
                    // Tạo chuỗi định dạng với căn chỉnh
                    std::ostringstream oss;
                    oss << std::left << std::setw(24) << str1
                        << " " << std::left << std::setw(15) << str2;
                    std::string displayText = oss.str();
